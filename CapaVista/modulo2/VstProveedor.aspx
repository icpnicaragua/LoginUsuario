<%@ Page Title="" Language="C#" MasterPageFile="~/Pm1.Master" AutoEventWireup="true" CodeBehind="VstProveedor.aspx.cs" Inherits="CapaVista.modulo2.VstProveedor" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="header">
                ...
                <div class="form-group">
                    <asp:LinkButton ID="lbRegimen" href="#Regimen" data-toggle="collapse" runat="server" CssClass="btn btn-info btn3d">Regimen</asp:LinkButton>
                    <asp:LinkButton ID="lbProveedor" href="#Proveedor" data-toggle="collapse" runat="server" CssClass="btn btn-info btn3d">Proveedor</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
    <div id="DivNavegadorInfo" class="container-fluid bg-white">
        <div class="row">
            <div class="header">
                <h4>Administrar Información de Proveedores</h4>
                <div class="form-group">
    ...
    <div class="container-fluid">
        <div class="row">
            <div id="Regimen" class="  col-lg-6 col-md-6 col-sm-12 collapse">
                <div class="card bg-light mb-3">
                    <div class="card-header">
                        <h2 class="d-inline-block">Regimen</h2>
                        <div class="d-inline-block pull-right">
                            <asp:LinkButton ID="lbNRegimen" href="#modalNRegimen" data-toggle="modal" runat="server" CssClass="btn btn-success  btn3d "><i class="fas fa-plus fa-2x"></i></asp:LinkButton><!-- id href-->
                            <asp:LinkButton ID="lbMostrarRegimen" href="#secciontblRegimen" runat="server" Text="Mostrar Regimen" CssClass="btn btn-info btn3d" data-toggle="collapse"><i class="far fa-eye fa-2x"></i></asp:LinkButton><!-- id href text-->
                        </div>
                    </div>
                    <div class="card-body">
                        <div id="secciontblRegimen" class="table-responsive collapse">
                            <table id="tblRegimen" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Regimen</th>
        ...
        <div class="row">
            <div id="Proveedor" class=" col-lg-12 col-md-12 col-sm-12 collapse">
                <div class="card bg-light mb-3">
                    <div class="card-header">
                        <h2 class="d-inline-block">Proveedor</h2>
                        <div class="d-inline-block pull-right">
                            <asp:LinkButton ID="lbNProveedorPersona" href="#ProveedorNPersona" data-toggle="collapse" runat="server" CssClass="btn btn-success  btn3d "><i class="fas fa-user fa-2x"></i></asp:LinkButton>
                            <asp:LinkButton ID="lbNProveedorEmpresa" href="#ProveedorNEmpresa" data-toggle="collapse" runat="server" CssClass="btn btn-success  btn3d "><i class="fas fa-suitcase fa-2x"></i></asp:LinkButton>
                            <asp:LinkButton ID="lbMostrarProveedor" href="#secciontblProveedor" runat="server" Text="Mostrar Proveedor" CssClass="btn btn-info btn3d" data-toggle="collapse"><i class="far fa-eye fa-2x"></i></asp:LinkButton>
                        </div>
                    </div>
                    <div class="card-body">
                        <div id="secciontblProveedor" class="table-responsive collapse">
                            <table id="tblProveedor" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Proveedor</th>
                   ...
                   <div class="row">
       <div id="ProveedorNPersona" class="  col-lg-6 col-md-12 col-sm-12 collapse">
           <div class="card bg-light mb-3">
               <div class="card-header">
                   <h2 class="d-inline-block">Agregar Persona a Proveedores</h2>
                   <div class="d-inline-block pull-right">
                   </div>
               </div>
               <div class="card-body">
                   <div id="secciontblProveedorNPersona" class="table-responsive ">
                       <table id="tblProveedorNPersona" class="table table-bordered table-hover">
                           <thead>
                               <tr>
                                   <th>Id Persona</th>
                                   <th>Nombre</th>
                           ...
                           <tbody id="tblBodyProveedorNPersona">
                           </tbody>
                       </table>
                   </div>
               </div>
       ...
       <div id="ProveedorNEmpresa" class="  col-lg-6 col-md-12 col-sm-12 collapse">
           <div class="card bg-light mb-3">
               <div class="card-header">
                   <h2 class="d-inline-block">Agregar Empresa a Proveedores</h2>
                   <div class="d-inline-block pull-right">
                   </div>
               </div>
               <div class="card-body">
                   <div id="secciontblProveedorNEmpresa" class="table-responsive ">
                       <table id="tblProveedorNEmpresa" class="table table-bordered table-hover">
                           <thead>
                               <tr>
                                   <th>Id Persona</th>
                           ...
                           <tbody id="tblBodyProveedorNEmpresa">
                           </tbody>
                       </table>
                   </div>
               </div>
    ...
    <div class="container-fluid bg-info">
        <div class="row">
            <div id="Empresa" class=" col-lg-12 col-md-12 col-sm-12 collapse">
                <div class="card bg-light mb-3">
                    <div class="card-header">
                        <h2 class="d-inline-block">Click en la fila para màs informaciòn</h2>
                        <div class="d-inline-block pull-right">
    ...
    <div id="alertaProveedor" class="modal bd-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal" id="modalNRegimen">
        <div class="modal-dialog" role="document">
            <div id="DivModBorRegimen" class="modal-content border-success">
                <div id="DivModHeaRegimen" class="modal-header bg-success">
                    <h4 id="H4ModTitRegimen">Editar Regimen</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="close"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    <div id="frmnueRegimen" runat="server" data-toggle="validator" role="form">
                        <label id="lblexistenuevRegimen" for="txtNuevoRegimenn" runat="server" class="text-warning" text=""></label>
                        <div class="input-group mb-3">
                            <asp:TextBox ID="txtNuevoRegimen" runat="server" TabIndex="1" CssClass="form-control" placeholder="Nuevo Regimen" data-required-error="dddd" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]*$" MaxLength="20" ClientIDMode="Static"></asp:TextBox><!-- id placeholder pattern maxlen-->
                        ...
                        <button id="btnNueRegimen" tabindex="2" class="btn btn-success pull-right">
    ...
    <div class="modal" id="modalNProveedor">
        <div class="modal-dialog" role="document">
            <div id="DivModBorProveedor" class="modal-content border-success">
                <div id="DivModHeaProveedor" class="modal-header bg-success">
                    <h4 id="H4ModTitProveedor">Editar Proveedor</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="close"><span>&times;</span></button>
                </div>
                <div class="modal-body">
                    <div id="frmnueProveedor" runat="server" data-toggle="validator" role="form">
                        <label id="lblexistenuevoProveedor" for="txtNuevoNombre" runat="server" class="text-warning" text=""></label>
                        <div class="input-group mb-3">
                            <asp:TextBox ID="txtNuevoNombre" runat="server" TabIndex="0" CssClass="form-control" placeholder="Nuevo Proveedor" ClientIDMode="Static"></asp:TextBox>
                            <span class="input-group-addon">
                        ...
                        <div class="input-group mb-3">
                            <asp:TextBox ID="txtNuevoPlazoCredito" runat="server" TabIndex="1" CssClass="form-control" placeholder="Nuevo Plazo Crédito" data-required-error="dddd" pattern="[0-9]+" ClientIDMode="Static"></asp:TextBox>
                            <span class="input-group-addon">
                        ...
                        <button id="btnNueProveedor" tabindex="2" class="btn btn-success pull-right">
                            <i class="fas fa-save fa-2x"></i>
                        </button>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphJs" runat="server">
    ...
    <script src="/js/icp/CRUDERegimen.js" type="text/javascript"></script>
    ...
    <script src="/js/icp/CRUDEProveedor.js" type="text/javascript"></script>
