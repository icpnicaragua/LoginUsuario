...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="navegadorMVETC" class="container-fluid">
        <div class="row">
            <div class="header">
               ...
               <asp:LinkButton ID="lbprueba" href="#M" data-toggle="collapse" runat="server" CssClass="btn btn-info btn3d">ocultar</asp:LinkButton>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <%--fin tabla vista--%>
            <%--tabla modulos--%>
            <div id="M" class="  col-lg-6 col-md-6 col-sm-12 collapse">  <%--id  xxxx--%>
                <div class="card bg-light mb-3">
                    <div class="card-header">
                        <h2 class="d-inline-block">Módulo</h2>
                        <div class="d-inline-block pull-right">
                            <asp:LinkButton ID="lbMN" href="#ModModulo" data-toggle="modal" runat="server" CssClass="btn btn-success btn3d"><i class="fas fa-plus fa-2x"></i></asp:LinkButton>  <%--id href xxxx--%>
                            <asp:LinkButton ID="lbMostrarM" href="#secciontblM" runat="server" Text="Mostrar Módulo" CssClass="btn btn-info btn3d" data-toggle="collapse"><i class="far fa-eye fa-2x"></i></asp:LinkButton> <%--id href text xxxx--%>
                        </div>
                    </div>
                    <div class="card-body">
                        <div id="secciontblM" class="table-responsive collapse"> <%--id tabla xxxx--%>
                            <table id="tblM" class="table table-bordered table-hover"> <%--id  xxxx--%>
                                <thead>
                                    <tr><%--los th son las columnas de la tabla xxxx--%>
                                        <th>ID</th>
                                        <th>Módulo</th>
                                        <th>Inicio</th>
                                        <th>Asp</th>
...
<%--<input type="text" id="txtCElemAs" tabindex="2" class="form-control" placeholder="Nuevo Id Asp" data-required-error="dddd" pattern="^[_A-z0-9]{3,10}$" maxlength="10" >--%>
        ...
        <%--fin modales Elem--%>
     <%--modal vista--%>
        <div class="modal" id="ModCVista">   <%--id xxxx--%>
            <div class="modal-dialog" role="document">
                <div id="DivModBorVista" class="modal-content border-success">
                    <div id="DivModHeadVista" class="modal-header bg-success">
                        <h4 id="H4ModTitVista">Nueva Vista</h4> <%-- texto xxxx--%>
                        <button type="button" class="close" data-dismiss="modal" aria-label="close"><span>&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div  id="frmCVista" runat="server" data-toggle="validator" role="form">
                            <label id="lblCVista" for="txtCVista" class="text-warning"></label> <%--id for xxxx--%>
                            <div class="input-group mb-3">
                                <asp:TextBox id="txtCVista" tabindex="1" class="form-control" placeholder="Nueva Vista" data-required-error="dddd" pattern="^\w+(\s\w+)*$" maxlength="30"  runat="server"></asp:TextBox> <%--id tabindex placeholder pattern maxleng xxxx--%>
                                <span class="input-group-addon">
                                    <button type="button" class="btn btn-secondary popinfo1" data-container="body" data-toggle="popover" data-placement="top" data-content="">
                                        <i class="fas fa-info"></i>
                                    </button>
                            ...
                            <asp:Label ID="lblCAspVista" runat="server" for="txtCAspVista" CssClass="text-warning" Text=""></asp:Label>  <%--id for xxxx--%>
                            <div class="input-group mb-3">
                                <asp:TextBox id="txtCAspVista" tabindex="2" class="form-control" placeholder="Nuevo IdAsp" data-required-error="dddd" pattern="^[_A-z0-9]{3,10}$" maxlength="10"  runat="server"></asp:TextBox>  <%--id tabindex placeholder pattern maxleng xxxx--%>
                                <span class="input-group-addon">
                                    <button type="button" class="btn btn-secondary popinfo2" data-container="body" data-toggle="popover" data-placement="top" data-content="">
                                        <i class="fas fa-info"></i>
                                    </button>
                            ...
                            <div class="input-group md-3">
                                <asp:DropDownList ID="ddlCVistaModulo" TabIndex="3" CssClass="form-control border-success" runat="server">  <%--id tap xxxx--%>
                                </asp:DropDownList>
                            </div>
        ...
        <%--fin modales vista--%>
        <%--modal modulo--%>
    <div class="modal" id="ModModulo">   <%--id xxxx--%>
            <div class="modal-dialog" role="document">
                <div id="DivModBorModulo" class="modal-content border-success"> <%--id xxxx--%>
                    <div id="DivModHeadModulo" class="modal-header bg-success"> <%--id xxxx--%>
                        <h4 id="H4ModTitModulo">MÓDULO</h4> <%-- texto xxxx--%> <%--id xxxx--%>
                        <button type="button" class="close" data-dismiss="modal" aria-label="close"><span>&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div  id="FrmModulo" runat="server" data-toggle="validator" role="form"> <%--id xxxx--%>
                            <label id="lblModulo" for="TxtModulo" class="text-warning"></label> <%--id for xxxx--%>
                            <div class="input-group mb-3">
                                <asp:TextBox id="TxtModulo" tabindex="1" Cssclass="form-control" placeholder="Nuevo Módulo" data-required-error="dddd" pattern="^[_A-z0-9]{3,}$" maxlength="10"  runat="server" ClientIDMode="Static"></asp:TextBox> <%--id tabindex placeholder pattern maxleng xxxx--%>
                                          <span class="input-group-addon">
                                    <button type="button" class="btn btn-secondary popinfo1" data-container="body" data-toggle="popover" data-placement="top" data-content="">
                                        <i class="fas fa-info"></i>
                                    </button>
                            ...
                            <asp:Label ID="LblModuloAsp" runat="server" for="TxtModuloAsp" CssClass="text-warning" Text=""></asp:Label>  <%--id for xxxx--%>
                            <div class="input-group mb-3">
                                <asp:TextBox id="TxtModuloAsp" tabindex="2" class="form-control" placeholder="Nuevo ID Asp Módulo" data-required-error="dddd" pattern="^[_A-z0-9]{3,10}$" maxlength="10"  runat="server" ClientIDMode="Static"></asp:TextBox>  <%--id tabindex placeholder pattern maxleng xxxx--%>
                                <span class="input-group-addon">
                                    <button type="button" class="btn btn-secondary popinfo2" data-container="body" data-toggle="popover" data-placement="top" data-content="">
                                        <i class="fas fa-info"></i>
                                    </button>
                              ...
                              <button id="BtnCUDModulo" tabindex="3" type="submit"   class="btn btn-success pull-right"> <%--id index xxxx--%>
                                <i class="fas fa-save fa-2x"></i>
                            </button>
                            </div>
                    </div>
